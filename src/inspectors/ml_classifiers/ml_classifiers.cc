...
{
    /*
    Para cada pacote "p", � preciso:
        - Criar, a partir de suas informa��es, um respectivo "flow_id";
        - Com base neste "flow_id", verificar se o mesmo j� existe dentro da lista de conex�es;
            - Se existe, �timo, basta adicionar as informa��es do novo pacote � respectiva conex�o;
            - Se n�o existe, � preciso criar uma nova conex�o, inicializar seus campos e adicionar � lista de conex�es.
    */
    if ((p->is_tcp() || p->is_icmp()) && p->flow) {
