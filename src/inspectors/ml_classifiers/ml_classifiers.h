...
void classify_connections() {
    ...
    outputFile.open("/home/minh/newmljoblibtest/src/inspectors/ml_classifiers/tmp/timeouted_connections.txt", std::ios_base::trunc);
    ...
    outputFile.close();
    outputFile.open("/home/minh/newmljoblibtest/src/inspectors/ml_classifiers/tmp/timeouted_connections_id.txt", std::ios_base::trunc);
    for (int i = 0; i < t_connections.id.size(); i++)
    {
    ...
    std::string py_cmd = "/home/minh/miniconda3/bin/python3 /home/minh/newmljoblibtest/src/inspectors/ml_classifiers/ml_classifiers.py " + ml_technique;
    system(py_cmd.c_str());
    ...
    if (inputFile.is_open()) {
        ...
        while (std::getline(inputFile, line)) {
            ...
            } else if (predictedValue == 1.0f){
                std::cout << "Maybe TCP SYNFLOOD (" << predictedValue << ")" << std::endl;
            }
              else {
                std::cout << "Maybe http slowloris (" << predictedValue << ")" << std::endl;
